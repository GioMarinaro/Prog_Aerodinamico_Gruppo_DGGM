...
def analizza_plot_csv(cartella_base):
    x_csv = os.path.join(cartella_base, "X_Direction.csv")
    y_csv = os.path.join(cartella_base, "Y_Direction.csv")
...
def analizza_plot_txt(cartella_base):
    x_file = os.path.join(cartella_base, "X_Direction")
    y_file = os.path.join(cartella_base, "Y_Direction")
...
def analizza_reports_txt(cartella_base):
    report_path = os.path.join(cartella_base, "Reports.txt")
...
if __name__ == "__main__":
    percorso = os.path.join(os.path.dirname(os.path.abspath(__file__)), "simulazioni_flap_star")
    risultati, fieldnames = analizza_tutte_cartelle(percorso)
    output_csv = os.path.join(os.path.dirname(os.path.abspath(__file__)), "risultati_deviazione.csv")
